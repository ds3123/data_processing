...
class Excel_Styles():
    ...
    def __init__(self):
        ...
        _error_Style.fill      = PatternFill("solid", fgColor="FF0000")
    ...
    def set_Default_Style( self  , column_List , sheet , idx ):
        for col in column_List :
            sheet[ col + str( idx+1 ) ].style = self.default_Style

    # 設定 _ 錯誤樣式
    def set_Error_Style( self , column_List , sheet , idx ):
        for col in column_List :
            sheet[ col + str( idx+1 ) ].style = self.error_Style
